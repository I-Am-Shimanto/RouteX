                ...
                <div className="row bg-brand-color rounded-[35px] flex items-center pt-[81.73px] pl-[180.95px]">
                    <div className="banner-text">
                        ...
                        <div className='flex gap-[21.02px]'>
                            <Link className='flex items-center gap-[7.1px] py-[10.29px] px-[21.29px] border-[1px] border-white rounded-[708px] text-[10px] font-jakarta font-semibold text-white leading-[21.3px]'>Read More <FaArrowRight/></Link>
