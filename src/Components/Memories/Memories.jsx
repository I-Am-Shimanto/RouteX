        ...
        <section>
            <div className="container">
                <div className="bg-brand-color rounded-[35.48px] pt-[80.89px] pl-[180.95px]">
                    ...
                    <img className='w-[160px] h-[299.45px] rounded-[20px] hover:scale-[1.05] duration-[0.3s]' src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQ52dSQ-LjLwKYnyDi827S44zalCoEndPR3Yg&s" alt="memories" />
                    <div className="single relative">
                        <img className='w-[290.93px] h-[299.45px] rounded-[20px] hover:scale-[1.05] duration-[0.3s]' src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQkp5hzqXKC8Nryh1gTGnHN6NCj3_mAxokhPTV11GGYwONK97snbuejTsU5llEgiUs_CrE&usqp=CAU" alt="memories" />
                    ...
                    <img className='w-[160px] h-[299.45px] rounded-[20px] hover:scale-[1.05] duration-[0.3s]' src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQAsGPYGjZ3xHk2reHxvxLJ69qrGjZjKWzKUg&s" alt="memories" />
                    <img className='w-[160px] h-[299.45px] rounded-[20px] hover:scale-[1.05] duration-[0.3s]' src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcS1-8lgNdfvb7IdWEFgH-wr2zOUO2TtVQtM3g&s" alt="memories" />
                    <img className='w-[160px] h-[299.45px] rounded-[20px] hover:scale-[1.05] duration-[0.3s]' src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQ52dSQ-LjLwKYnyDi827S44zalCoEndPR3Yg&s" alt="memories" />
                    </div>
                </div>
            </div>
