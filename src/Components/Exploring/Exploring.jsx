                ...
                <div className="text flex justify-between px-[260.27px] flex-col ">
                        <div className='flex items-center gap-[7.1px] pt-[52.16px]'>
                            ...
                            <div className='box flex justify-between'>
                                ...
                                <div className="singlecard flex items-center justify-between w-[590.15px] h-[92.25px] border-[1px] border-[#E3DBD8] rounded-[14.19px] py-[21px] px-[28.38px] bg-white hover:scale-[1.05] duration-[0.3s]">
                                    <div className="text">
                                ...
                                <div className="img relative hover:scale-[1.05] duration-[0.3s]">
